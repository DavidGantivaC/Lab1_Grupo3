                ...
                switch(opcion)
                {
                        ...
                        case 2:
                                ...
                                if (resv==1){
                                        ...
                                        printf("Esto es strArr[0] x fuera: %s\n", strArr[0]);
                                        printf("Esto es strArr[1] x fuera: %s\n", strArr[1]);
                                        printf("Esto es strArr[2] x fuera: %s\n", strArr[2]);
                                        printf("Esto es strArr[3] x fuera: %s\n", strArr[3]);
...
void conversor ( char a[], char *strArr[])            //transforma el string a un arreglo de numeros
{
        ...
        printf("esto es i(cuantos numeros hay) : %i \n", i);
